...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun {id;_} -> not (id = i)) !evt
...
let _ = remove_listener newswire fakeNewsId;;
let _ = remove_listener newswire buzzFakeId;;
...
let _ = fire_event publish h4;;
let _ = fire_event publish h5;;
let _ = fire_event publish h6;;
